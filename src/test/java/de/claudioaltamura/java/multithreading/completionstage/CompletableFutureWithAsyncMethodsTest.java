...
class CompletableFutureWithAsyncMethodsTest {
  ...
  @Test
  @DisplayName("methods with Async postfix running a corresponding step of execution in another thread.")
  void asyncMethods() throws InterruptedException, ExecutionException {
    ...
    CompletableFuture<String> completableFuture = completableFutureWithEncapsulatedLogic.calculateAsync("hello")
